...
/* ── Admin gets only TOP tier of each group ── */
function getAdminBadges() {
// شارة واحدة فقط لكل مجموعة — الأعلى مستوى
return [
‘friends_diamond’,
‘login_diamond’,
‘room_diamond’,
...
/* شارة فارغة للمستوى غير المكتسب في popup */
function buildLockedBadgeSVG(key) {
const def = BADGE_DEFS[key];
if (!def) return ‘’;
return buildBadgeSVG(key);
}
